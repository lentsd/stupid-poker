...
const SPECIAL_ROLES = [
  ...
  'Гангстер — ночью не глядя меняешь местами по 1 карте двум другим игрокам, либо 1 свою карту на 1 чужую',
];
const PEACEFUL_ROLE = 'Мирный — просто терпишь';

/**
 * Всегда 4 спецроли (мафия + проститутка + шериф + гангстер) + мирные до playerCount.
 * Если игроков меньше 4 — берём только нужное кол-во спецролей.
 */
